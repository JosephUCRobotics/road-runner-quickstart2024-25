...
@Autonomous(name = "AutoRungSecondBlockQual", group = "B")
public final class AutoRungSecondBlock extends LinearOpMode {
...
//        }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectoryActionBuilder PathToRung3 = drive.actionBuilder(new Pose2d(0, 62, Math.PI*.75))
                .setTangent(Math.PI * -.5)
                .splineToConstantHeading(new Vector2d(0, 45), Math.PI*-.5);
                ...
                new ParallelAction(
                        ...
                        new SequentialAction(
                                new ParallelAction(
                                        ...
                                        arm.ElbowMoveTo(-810, 1500, 2000, 0)),//780
                                arm.ShoulderMoveTo(350, 1500, 2000, 760),
                                arm.OpenClaw2(),
                                driveTo1stSpikeMark,
                                new ParallelAction(
                                        arm.OpenClaw(),
                                        arm.ElbowMoveTo(-2650, 1500, 2000, -810),
                                        driveToPickUpBlock1),
                                arm.CloseClaw(),
                                new ParallelAction(
                                        firstPathToHuman,
...
//                                pathToHook1,
                                ...
                                arm.ShoulderMoveTo(1455, 1500, 2000, 1600),
                                ...
                                driveToRung3,
                                arm.FlatClaw(),
                                arm.ElbowMoveTo(-6300, 1500, 2000, -5695),
                                arm.OpenClaw()
                        )
                )
        );

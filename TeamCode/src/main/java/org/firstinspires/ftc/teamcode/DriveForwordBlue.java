...
@Autonomous(name = "Drive ForwardBlue", group = "B")
public final class DriveForwordBlue extends LinearOpMode {
...
//        Pose2d initialPose = new Pose2d(50, 52, -Math.PI/180 * 36);
        ...
        TrajectoryActionBuilder driveToPark = drive.actionBuilder(initialPose)
                ...
                .splineToSplineHeading(new Pose2d(-65, 38, Math.PI), Math.PI*.5);

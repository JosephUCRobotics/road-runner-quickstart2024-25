...
@Autonomous(name = "AutoBucketPath", group = "B")
public final class AutoBucketPath extends LinearOpMode {
    public class Arm {
...
//        }
    ...
    public void runOpMode() throws InterruptedException {
        Pose2d initialPose = new Pose2d(42, 64, Math.PI*.75);
        ...
        TrajectoryActionBuilder firstPathToBuckets = drive.actionBuilder(initialPose)
                ...
                .splineToSplineHeading(new Pose2d(62, 60, Math.PI*.5), 0);
                ...
                new ParallelAction(
                        ...
                        new SequentialAction(
                                new ParallelAction(
                                        ...
                                        arm.ShoulderMoveTo(3700, 1500, 2000),
                                        arm.ElbowMoveTo(-4000, 1500, 2000)),
                                arm.OpenClaw2(),
                                new ParallelAction(
                                        driveTo1stSpikeMark,
                                        arm.ElbowMoveTo(-5500, 1500, 3000)),
                                new ParallelAction(
                                        arm.ShoulderMoveTo(1350, 4000, 4000),
                                        arm.ReddyClaw()
                                        ),
                                driveToPickUpBlock1,
                                arm.CloseClaw(),
                                ...
                                new ParallelAction(
                                        arm.basketClaw(),
                                        arm.ShoulderMoveTo(3700, 3000, 3000),
                                        arm.ElbowMoveTo(-4000, 3000, 3000)),
                                arm.OpenClaw2(),
                                new ParallelAction(
                                        driveTo2ndSpikeMark,
                                        arm.ElbowMoveTo(-5500, 1500, 3000)),

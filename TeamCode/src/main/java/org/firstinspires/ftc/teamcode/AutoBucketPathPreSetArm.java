...
@Autonomous(name = "AutoBucketQualifier", group = "A")
...
String s = "";
        ...
        public Action ElbowMoveTo(double pos, double acc, double maxV) {
            return new ElbowMoveTo(pos, acc, maxV, shoulder.getCurrentPosition());
        }
...
//        }
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d initialPose = new Pose2d(42-initialOffset, 64, Math.PI*.75);
        ...
        TrajectoryActionBuilder firstPathToBuckets = drive.actionBuilder(initialPose)
                .setTangent(-Math.PI*.05)
                .splineToSplineHeading(new Pose2d(62, 60, Math.PI*.5), 0, null, new ProfileAccelConstraint(-10, 10));

        TrajectoryActionBuilder pathTo1stSpikeMark = drive.actionBuilder(new Pose2d(62, 60, Math.PI*.5))
                .setTangent(Math.PI*-.75)
                .splineToSplineHeading(new Pose2d(48, 50, Math.PI*.75), Math.PI*-.5, null, new ProfileAccelConstraint(-15, 15));

        TrajectoryActionBuilder pathToPickUpBlock1 = drive.actionBuilder(new Pose2d(48, 50, Math.PI*.75))
                .setTangent(-Math.PI*.5)
                .splineToConstantHeading(new Vector2d(48, 44), -Math.PI*.5);

        TrajectoryActionBuilder secondPathToBuckets = drive.actionBuilder(new Pose2d(48, 44, Math.PI*.75))
                .setTangent(Math.PI*.5)
                .splineToConstantHeading(new Vector2d(48, 48), Math.PI*.5)
                .splineToConstantHeading(new Vector2d(67, 57), Math.PI*.2);
        TrajectoryActionBuilder pathTo2ndSpikeMark = drive.actionBuilder(new Pose2d(67, 57, Math.PI*.75))
                .setTangent(-Math.PI*.6)
                .splineToSplineHeading(new Pose2d(60, 51, Math.PI*.75), Math.PI*-.5, null, new ProfileAccelConstraint(-15, 15));

        TrajectoryActionBuilder pathToPickUpBlock2 = drive.actionBuilder(new Pose2d(60, 51, Math.PI*.75))
                .setTangent(-Math.PI*.5)
                .splineToConstantHeading(new Vector2d(60, 44), -Math.PI*.5);

        TrajectoryActionBuilder thirdPathToBuckets = drive.actionBuilder(new Pose2d(60, 44, Math.PI*.75))
                .setTangent(Math.PI*.5)
                .splineToConstantHeading(new Vector2d(68, 57), Math.PI*.2);

        TrajectoryActionBuilder pathTo3rdSpikeMark = drive.actionBuilder(new Pose2d(68, 57, Math.PI*.75))
                .setTangent(-Math.PI*.5)
                .splineToSplineHeading(new Pose2d(67.5, 52, Math.PI*.75), Math.PI*-.5, null, new ProfileAccelConstraint(-15, 15));

        TrajectoryActionBuilder pathToPickUpBlock3 = drive.actionBuilder(new Pose2d(67.5, 52, Math.PI*.75))
                .setTangent(-Math.PI*.5)
                .turn(Math.PI*.05)
                .splineToConstantHeading(new Vector2d(67.5, 38), -Math.PI*.5);
        TrajectoryActionBuilder forthPathToBuckets = drive.actionBuilder(new Pose2d(67.5, 38, Math.PI*.75))
                .setTangent(Math.PI*.5)
                .splineToSplineHeading(new Pose2d(67.5, 57, Math.PI*.75), Math.PI*.5);
...
//                    .splineToSplineHeading(new Pose2d(61, 72, Math.PI*.5), Math.PI*.25);
        ...
        Action secondDriveToBuckets = secondPathToBuckets.build();
        Action thirdDriveToBuckets = thirdPathToBuckets.build();
        Action forthDriveToBuckets = forthPathToBuckets.build();
                ...
                new ParallelAction(
                        ...
                        new SequentialAction(
                                new ParallelAction(
                                        ...
                                        arm.ShoulderMoveTo(3700, 1500, 2000, 0),
                                        arm.ElbowMoveTo(-4000, 1500, 2000, 0)),
                                arm.OpenClaw2(),
                                new ParallelAction(
                                        driveTo1stSpikeMark,
                                        arm.ElbowMoveTo(-5500, 1500, 3000, -4000)),
                                new ParallelAction(
                                        arm.ShoulderMoveTo(1455, 4000, 4000, 3700),
                                        arm.ReddyClaw()
                                        ),
                                driveToPickUpBlock1,
                                arm.CloseClaw(),
                                secondDriveToBuckets,
                                new ParallelAction(
                                        arm.basketClaw(),
                                        arm.ShoulderMoveTo(3700, 3000, 3000, 1455),
                                        arm.ElbowMoveTo(-4000, 3000, 3000, -5500)),
                                arm.OpenClaw2(),
                                new ParallelAction(
                                        driveTo2ndSpikeMark,
                                        arm.ElbowMoveTo(-5500, 1500, 3000, -4000)),

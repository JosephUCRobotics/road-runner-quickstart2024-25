...
public class PIDController {
     ...
     */
    public PIDController(double Kp, double Ki, double Kd, double Kv, double Ka) {
        this.Kp = Kp;
        this.Ki = Ki;
        this.Kd = Kd;
        this.Kv = Kv;
    ...
    public void updatePID(double Kp, double Ki, double Kd, double Kv, double Ka) {
        this.Kp = Kp;
        this.Ki = Ki;
        this.Kd = Kd;
        this.Kv = Kv;
     ...
     */
    public double output(double reference, double state, double desiredVelocity) {
        double error;
        double derivative;
        ...
        double output = (desiredVelocity*Kv)+(error * Kp) + (integral * Ki) + (derivative * Kd);

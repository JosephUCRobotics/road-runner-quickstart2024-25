...
@Autonomous(name = "AutoRedStateCorner", group = "A")
public final class AutoRedStateCorner extends LinearOpMode {
...
//                .splineToSplineHeading(new Pose2d(-55, 14, Math.PI*.66), 0);
                ...
                .turnTo(Math.PI*.45);
        TrajectoryActionBuilder driveToPickup = drive.actionBuilder(new Pose2d(-53, -16, Math.PI*.45))
                .turnTo(-Math.PI*.60)
                ...
                .splineToConstantHeading(new Vector2d(-63, -64), Math.PI*-.5)
                .setTangent(Math.PI*.4)
                .splineToConstantHeading(new Vector2d(-53, -16), Math.PI*.5)
                .turnTo(Math.PI*.45);
        TrajectoryActionBuilder driveToPickup2 = drive.actionBuilder(new Pose2d(-53, -16, -Math.PI*.45))
                .setTangent(0)
                .splineToSplineHeading(new Pose2d(-41,-12,Math.PI*-.5),0)
                .splineToConstantHeading(new Vector2d(-37, -55), -Math.PI*.5)
                .setTangent(Math.PI*.6)
                .splineToSplineHeading(new Pose2d(-53, -16, Math.PI*.47), Math.PI*.5);
...
//                .turnTo(Math.PI*-.75);
        ...
        TrajectoryActionBuilder driveToPark = drive.actionBuilder(new Pose2d(-55, -16, Math.PI*.47))
                .setTangent(0)
                .splineToConstantHeading(new Vector2d(-36, -20), Math.PI*-.25);
